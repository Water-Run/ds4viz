    ...
    <div class="templates-page">
        ...
        <header class="templates-page__header">
            ...
            <div class="templates-page__search">
                <span class="material-symbols-outlined templates-page__search-icon">
                    search
                </span>
                <input
                    v-model="searchInput"
        ...
        <div class="templates-page__body">
                ...
                <ul class="category-list">
                        ...
                        <button
                            ...
                            :class="{
                                'category-list__item--active':
                                    selectedCategory.length === 0 && !isSearchMode,
                            }"
                    ...
                    <li v-for="cat in categories" :key="cat">
                        <button
                            ...
                            :class="{
                                'category-list__item--active':
                                    selectedCategory === cat && !isSearchMode,
                            }"
            ...
            <section class="templates-page__content">
                ...
                >
                    <span class="material-symbols-outlined templates-page__empty-icon">
                        folder_open
                    </span>
...
.templates-page__search-clear .material-symbols-outlined {
    font-size: 16px;
}
...
.template-card__fav .material-symbols-outlined {
    font-size: 18px;
}

.template-card__fav--active .material-symbols-outlined {
